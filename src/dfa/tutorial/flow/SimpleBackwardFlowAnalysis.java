...
public class SimpleBackwardFlowAnalysis extends BackwardFlowAnalysis<Unit, Set<Value>> {

    // コンストラクタでコントロールフローフラグメントを受け取る
    public SimpleBackwardFlowAnalysis(UnitGraph graph) {
        super(graph);
        // 解析の実行
        doAnalysis();
    }
    ...
    public static void main(String[] args) {
        ...
        // 逆方向フロー解析の実行
        SimpleBackwardFlowAnalysis analysis = new SimpleBackwardFlowAnalysis(graph);
